...
visual overview of the bot, pipeline, and archive experiments.
...
| `~saidmost <phrase> [chat=ch] [n]` | anyone | Who has said a phrase the most — ranks chatters by how many of their messages contain it. |
